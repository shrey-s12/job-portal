import { Profile, Job, FavoriteColor } from "./types.js";
...
export const favoriteColors: FavoriteColor[] = [
    { email: "shreynbd@gmail.com", color: "blue" },
    { email: "priya.sharma@email.com", color: "green" },
    { email: "neha.patel@email.com", color: "red" },
];
